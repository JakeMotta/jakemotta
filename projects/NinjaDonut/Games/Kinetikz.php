...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="600" height="600" id="Games/kinetikz" align="middle">
				<param name="movie" value="GoodGames/kinetikz.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/kinetikz.swf" width="600" height="600">
					<param name="movie" value="GoodGames/kinetikz.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
