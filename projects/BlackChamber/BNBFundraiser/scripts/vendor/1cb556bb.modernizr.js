...
(window.Modernizr = (function (e, t, n) {
  ...
  function T(e, t, r) {
    for (var i in e) {
      var s = t[e[i]];
      if (s !== n) return r === !1 ? e[i] : S(s, 'function') ? s.bind(r || t) : s;
    }
    return !1;
  }
  var r = '2.8.3',
    ...
    y = {}.hasOwnProperty,
    b;
  !S(y, 'undefined') && !S(y.call, 'undefined')
    ? (b = function (e, t) {
        return y.call(e, t);
      })
    : (b = function (e, t) {
        ...
        var r = m.call(arguments, 1),
          i = function () {
            if (this instanceof i) {
              ...
              var s = new e(),
                o = n.apply(s, r.concat(m.call(arguments)));
  ...
  for (var N in h) b(h, N) && ((g = N.toLowerCase()), (i[g] = h[N]()), v.push((i[g] ? '' : 'no-') + g));
  return (
    (i.addTest = function (e, t) {
      if (typeof e == 'object') for (var r in e) b(e, r) && i.addTest(r, e[r]);
      else {
        e = e.toLowerCase();
        if (i[e] !== n) return i;
    ...
    (i._version = r),
    (o.className = o.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (s ? ' js ' + v.join(' ') : '')),
    i
  );
})(this, this.document)),
  (function (e, t, n) {
