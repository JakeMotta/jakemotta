...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="550" height="550" id="Games/jamesthedeepseazebra" align="middle">
				<param name="movie" value="GoodGames/jamesthedeepseazebra.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/jamesthedeepseazebra.swf" width="550" height="550">
					<param name="movie" value="GoodGames/jamesthedeepseazebra.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
