...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="760" height="550" id="Games/crushthecastle" align="middle">
				<param name="movie" value="GoodGames/crushthecastle.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/crushthecastle.swf" width="760" height="550">
					<param name="movie" value="GoodGames/crushthecastle.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
