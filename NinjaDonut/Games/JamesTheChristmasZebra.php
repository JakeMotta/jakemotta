...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="600" height="300" id="Games/jamesthechristmaszebra" align="middle">
				<param name="movie" value="GoodGames/jamesthechristmaszebra.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/jamesthechristmaszebra.swf" width="600" height="300">
					<param name="movie" value="GoodGames/jamesthechristmaszebra.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
