...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="800" height="600" id="Games/chaosfaction" align="middle">
				<param name="movie" value="GoodGames/chaosfaction.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/chaosfaction.swf" width="800" height="600">
					<param name="movie" value="GoodGames/chaosfaction.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
