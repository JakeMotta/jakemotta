...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="640" height="480" id="Games/veldotblastV" align="middle">
				<param name="movie" value="GoodGames/veldotblastV.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/veldotblastV.swf" width="640" height="480">
					<param name="movie" value="GoodGames/veldotblastV.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
