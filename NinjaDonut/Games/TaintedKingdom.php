...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="700" height="475" id="Games/taintedkingdom" align="middle">
				<param name="movie" value="GoodGames/taintedkingdom.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/taintedkingdom.swf" width="700" height="475">
					<param name="movie" value="GoodGames/taintedkingdom.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
