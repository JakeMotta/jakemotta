...
(function (a, b) {
              ...
              if ((a = arguments[j]) != null)
                for (c in a) {
                  ...
                  l && f && (d.isPlainObject(f) || (g = d.isArray(f)))
                    ? (g ? ((g = !1), (h = e && d.isArray(e) ? e : [])) : (h = e && d.isPlainObject(e) ? e : {}), (i[c] = d.extend(l, h, f)))
                    : f !== b && (i[c] = f);
                }
            return i;
          }),
      ...
      if (d.acceptData(b)) {
        ...
        d.support.deleteExpando || i != a ? delete i[j] : (i[j] = null),
          l
            ...
            : h && (d.support.deleteExpando ? delete b[d.expando] : b.removeAttribute ? b.removeAttribute(d.expando) : (b[d.expando] = null));
      }
    },
  ...
  (d.event = {
    ...
    (d.Event = function (a) {
      ...
      a && a.type
        ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()) ? w : v))
        : (this.type = a),
  ...
  d.each(['live', 'die'], function (a, c) {
    d.fn[c] = function (a, e, f, g) {
      ...
      while ((h = a[i++]) != null) {
        ...
        if (c === 'live') for (var q = 0, r = n.length; q < r; q++) d.event.add(n[q], 'live.' + F(h, m), { data: e, selector: m, handler: f, origType: h, origHandler: f, preType: l });
    ...
    (function () {
      ...
      var k = function (b, d, e, g) {
        ...
        if (x.length > 1 && m.exec(b))
          ...
          if (d) {
            (q = g ? { expr: x.pop(), set: p(g) } : k.find(x.pop(), x.length === 1 && (x[0] === '~' || x[0] === '+') && d.parentNode ? d.parentNode : d, w)),
        ...
        if (f.call(n) === '[object Array]')
          if (u)
            if (d && d.nodeType === 1) for (t = 0; n[t] != null; t++) n[t] && (n[t] === !0 || (n[t].nodeType === 1 && k.contains(d, n[t]))) && e.push(j[t]);
  ...
  (X.optgroup = X.option),
    ...
    d.fn.extend({
      ...
      domManip: function (a, c, e) {
        ...
        if (this[0]) {
          (i = j && j.parentNode),
            d.support.parentNode && i && i.nodeType === 11 && i.childNodes.length === this.length ? (f = { fragment: i }) : (f = d.buildFragment(a, this, k)),
            (h = f.fragment),
    ...
    d.extend({
      ...
      clean: function (a, b, e, f) {
        ...
        if (e)
          for (h = 0; g[h]; h++)
            !f || !d.nodeName(g[h], 'script') || (g[h].type && g[h].type.toLowerCase() !== 'text/javascript')
              ? (g[h].nodeType === 1 && g.splice.apply(g, [h + 1, 0].concat(d.makeArray(g[h].getElementsByTagName('script')))), e.appendChild(g[h]))
  ...
  (d.fn.css = function (a, c) {
    ...
    c.documentElement.currentStyle &&
      (bm = function (a, b) {
        ...
        !bf.test(d) &&
          bg.test(d) &&
          ((c = f.left), e && (a.runtimeStyle.left = a.currentStyle.left), (f.left = b === 'fontSize' ? '1em' : d || 0), (d = f.pixelLeft + 'px'), (f.left = c), e && (a.runtimeStyle.left = e));
        return d === '' ? 'auto' : d;
      }),
    (bk = bl || bm),
    d.expr &&
      ...
      ajax: function (a, c) {
        ...
        h.promise(u),
          ...
          (e.dataTypes = d
            ...
            .split(bB)),
          e.crossDomain ||
            ((q = bF.exec(e.url.toLowerCase())), (e.crossDomain = q && (q[1] != bK[1] || q[2] != bK[2] || (q[3] || (q[1] === 'http:' ? 80 : 443)) != (bK[3] || (bK[1] === 'http:' ? 80 : 443))))),
  ...
  d.fn.extend({
    ...
    d.each(
      { slideDown: cc('show', 1), slideUp: cc('hide', 1), slideToggle: cc('toggle', 1), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } },
      function (a, b) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
          ...
          (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === e &&
              ((l += b.offsetTop),
              (m += b.offsetLeft),
              d.offset.doesNotAddBorder && (!d.offset.doesAddBorderForTableAndCells || !ce.test(b.nodeName)) && ((l += parseFloat(c.borderTopWidth) || 0), (m += parseFloat(c.borderLeftWidth) || 0)),
              (f = e),
              (e = b.offsetParent)),
