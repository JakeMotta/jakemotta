...
<div id="s-banner" style="background-image:url(../images/banners/courses.jpg)">
	<div id="s-banner-content"><span class="banner-text">Pistol ART III</span></div>
</div>
...
<div id="container">
        ...
        <div id="leftcolumn">
            ...
            <div class="content">
                <span class="large-text bold-text">Pistol ART III</span><div class="line"></div>
                <span class="gen-text grey">You will always be the first responder at your critical life incident. You must be prepared.</span>
            </div>
            
            <img id="class_photo" src="../images/courses/pistol_art_III.jpg">
            ...
            <div class="content">
                ...
                <span class="gen-text grey">
                    Let’s get in the fight! In Pistol ART III we learn to fight with the pistol.  This is an aggressive course as we are constantly moving, fighting to cover, engaging multiple targets, fixing weapons malfunctions on the move, fighting from a position of disadvantage to a position of advantage, one-handed shooting and manipulations, and much more!
                </span>
            </div> 
            ...
            <div class="content">
            	<a onClick="prevPage(3)"><img id="prev_class"></a>
                <a onClick="nextPage(3)"><img id="next_class"></a>
            </div>
