 ...
 */
public class midLaser extends lasers
{
    ...
    public midLaser()
    {
        ...
        laserSound = new GreenfootSound("laser2.mp3");
    ...
    public void imageChange()
    {
        ...
        if(laserTimer >= randomStart + 51)
        {
            if(laserTimer <= randomStart + 61) 
            {
                ...
                midBeam midBeam;
                midBeam = new midBeam();
                getWorld().addObject(midBeam, getX(), getY()+183);
