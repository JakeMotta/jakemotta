...
(function (a) {
  ...
  function c(c, b) {
    function ha(f) {
      if (v.data(Q + '_intouch') !== !0 && !(a(f.target).closest(b.excludedElements, v).length > 0)) {
    ...
    function la(c) {
      ...
      if (!(A === D || A === z || ta())) {
        var q,
          p = ua(r ? o.touches[0] : o);
        W = O();
        if (r) B = o.touches.length;
        b.hold && clearTimeout(ka);
        A = s;
        B == 2 &&
          (N == 0 ? (ia(1, o.touches[1]), (N = M = ja(x[0].start, x[1].start))) : (ua(o.touches[1]), (M = ja(x[0].end, x[1].end)), (K = I < 1 ? j : h)),
          (I = ((M / N) * 1).toFixed(2)),
          (L = Math.abs(N - M)));
        if (B === b.fingers || b.fingers === y || !r || V()) {
          ...
          n = G = n <= 45 && n >= 0 ? d : n <= 360 && n >= 315 ? d : n >= 135 && n <= 225 ? g : n > 45 && n < 135 ? i : f;
          if (b.allowPageScroll === k || V()) c.preventDefault();
          else
            switch (((m = b.allowPageScroll === l), n)) {
              case d:
          ...
          F = Math.round(Math.sqrt(Math.pow(p.end.x - p.start.x, 2) + Math.pow(p.end.y - p.start.y, 2)));
          E = W - aa;
          c = G;
          n = F;
          n = Math.max(n, va(c));
          ...
          if (!b.triggerOnTouchEnd || b.triggerOnTouchLeave)
            (c = !0),
              b.triggerOnTouchLeave &&
                ((c = a(this)),
                (n = c.offset()),
                (c = { left: n.left, right: n.left + c.outerWidth(), top: n.top, bottom: n.top + c.outerHeight() }),
                (c = p.end.x > c.left && p.end.x < c.right && p.end.y > c.top && p.end.y < c.bottom)),
              !b.triggerOnTouchEnd && c ? (A = ma(s)) : b.triggerOnTouchLeave && !c && (A = ma(D)),
              (A == z || A == D) && J(o, A);
        } else (A = z), J(o, A);
        q === !1 && ((A = z), J(o, A));
      }
    ...
    function na(a) {
      ...
      oa() || !pa()
        ? ((A = z), J(c, A))
        : b.triggerOnTouchEnd || (b.triggerOnTouchEnd == !1 && A === s)
        ? (a.preventDefault(), (A = D), J(c, A))
        : !b.triggerOnTouchEnd && b.tap
        ? ((A = D), R(c, A, q))
        : A === s && ((A = z), J(c, A));
      ba(!1);
      return null;
    ...
    function J(a, c) {
      ...
      Aa() && b.doubleTap && f !== !1
        ? (f = R(a, c, p))
        : E > b.longTapThreshold && F < C && b.longTap && f !== !1
        ? (f = R(a, c, n))
        : (B === 1 || !r) && (isNaN(F) || F < b.threshold) && b.tap && f !== !1 && (f = R(a, c, q));
      c === z && S(a);
      c === D && (r ? a.touches.length == 0 && S(a) : S(a));
      return f;
    }
    function R(c, k, l) {
      var s = void 0;
        ...
        if (k == D && xa()) {
          ...
          switch (G) {
            ...
            case g:
              ...
              b.swipeRight && (s = b.swipeRight.call(v, c, G, F, E, B, x));
              break;
            case f:
        ...
        if (k == D && za())
          switch (K) {
            case h:
              ...
              break;
            case j:
              v.trigger('pinchOut', [K || null, L || 0, E || 0, B, I, x]), b.pinchOut && (s = b.pinchOut.call(v, c, K || null, L || 0, E || 0, B, I, x));
          }
      }
      if (l == q) {
        if (k === z || k === D)
            ...
            b.doubleTap && !Aa()
              ? ((P = O()),
                (ea = setTimeout(
                  ...
                  b.doubleTapThreshold,
                )))
              : ((P = null), v.trigger('tap', [c.target]), b.tap && (s = b.tap.call(v, c, c.target)));
      } else if (l == p) {
        if (k === z || k === D) clearTimeout(ea), (P = null), v.trigger('doubletap', [c.target]), b.doubleTap && (s = b.doubleTap.call(v, c, c.target));
    ...
    function ba(a) {
      a === !0 ? (v.bind(ra, la), v.bind(sa, na), T && v.bind(T, qa)) : (v.unbind(ra, la, !1), v.unbind(sa, na, !1), T && v.unbind(T, qa, !1));
    ...
    function Ba() {
      for (var a = [], c = 0; c <= 5; c++) a.push({ start: { x: 0, y: 0 }, end: { x: 0, y: 0 }, identifier: 0 });
      return a;
    }
    function va(a) {
  ...
  a.fn.swipe.phases = { PHASE_START: w, PHASE_MOVE: s, PHASE_END: D, PHASE_CANCEL: z };
  a.fn.swipe.directions = { LEFT: d, RIGHT: g, UP: f, DOWN: i, IN: h, OUT: j };
  a.fn.swipe.pageScroll = { NONE: k, HORIZONTAL: t, VERTICAL: u, AUTO: l };
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName('meta'), b = 0, c = a.length; b < c; b++) {
        ...
        if ('generator' == d.getAttribute('name')) {
          '2017.0.1.363' != d.getAttribute('content') && Muse.assets.outOfDate.push('touchswipe.js');
          break;
        }
      }
    }
