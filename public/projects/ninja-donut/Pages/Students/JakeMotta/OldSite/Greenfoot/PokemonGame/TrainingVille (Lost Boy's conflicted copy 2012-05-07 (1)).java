...
public class TrainingVille extends World
{
    ...
    {    
        ...
        setPaintOrder(Ash.class, Rock.class, Tree.class, WaterRock.class, Water.class, PokeCenter.class, Market.class, Plant.class, TallGrass.class);
    ...
    public void PopulatePlants()
    {
        ...
        addObject(new Plant(), 58, 420);
        addObject(new Plant(), 58, 450);
        ...
        //left side of Market
        addObject(new Plant(), 257, 420);
        addObject(new Plant(), 257, 450);
        
        //right side of Market
        addObject(new Plant(), 342, 420);
        addObject(new Plant(), 342, 450);
