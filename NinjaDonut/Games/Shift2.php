...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="500" height="500" id="Games/shift2-ArmorGames" align="middle">
				<param name="movie" value="GoodGames/shift2-ArmorGames.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/shift2-ArmorGames.swf" width="500" height="500">
					<param name="movie" value="GoodGames/shift2-ArmorGames.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
