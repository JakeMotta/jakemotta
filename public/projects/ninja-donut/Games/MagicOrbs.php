...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="600" height="550" id="Games/release" align="middle">
				<param name="movie" value="GoodGames/release.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/release.swf" width="600" height="550">
					<param name="movie" value="GoodGames/release.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
