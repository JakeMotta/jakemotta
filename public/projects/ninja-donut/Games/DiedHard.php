...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="400" height="450" id="Games/diedhard" align="middle">
				<param name="movie" value="GoodGames/diedhard.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/diedhard.swf" width="400" height="450">
					<param name="movie" value="GoodGames/diedhard.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
