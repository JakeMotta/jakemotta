...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="500" height="560" id="Games/shift-4" align="middle">
				<param name="movie" value="GoodGames/shift-4.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/shift-4.swf" width="500" height="560">
					<param name="movie" value="GoodGames/shift-4.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
