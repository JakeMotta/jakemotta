...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="650" height="320" id="Games/lightbot" align="middle">
				<param name="movie" value="GoodGames/lightbot.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/lightbot.swf" width="650" height="320">
					<param name="movie" value="GoodGames/lightbot.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
