...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="640" height="480" id="Games/doodledefender" align="middle">
				<param name="movie" value="GoodGames/doodledefender.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/doodledefender.swf" width="640" height="480">
					<param name="movie" value="GoodGames/doodledefender.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
