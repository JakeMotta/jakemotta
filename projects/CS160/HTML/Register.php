	...
	<?php class register {
			public function signIn() {
				if(!empty($_POST)) {
					...
					{
						?>
						<div id="welcomeMsg" style="color: #5d5f63;font-size: 26px;text-align:center;margin-top:50px">This username is already taken.
							<a href="signUp.php<?php echo htmlspecialchars(SID); ?>"> Return to sign up page </a> </div>
						</div>
						<div id="Footer">
						</div>
					</div>
    ...
    <div id="container">
        	...
        	<div id="content">
            	<div id="form-holder">
                    ...
                    <div id="form-subheader">Your profile has successfully created!</div>
