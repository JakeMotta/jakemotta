...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="800" height="420" id="Games/thelaststand" align="middle">
				<param name="movie" value="GoodGames/thelaststand.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/thelaststand.swf" width="800" height="420">
					<param name="movie" value="GoodGames/thelaststand.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
