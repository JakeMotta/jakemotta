...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="800" height="420" id="Games/thelaststand2" align="middle">
				<param name="movie" value="GoodGames/thelaststand2.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/thelaststand2.swf" width="800" height="420">
					<param name="movie" value="GoodGames/thelaststand2.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
