...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="300" height="600" id="Games/PixelGrower" align="middle">
				<param name="movie" value="GoodGames/PixelGrower.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/PixelGrower.swf" width="300" height="600">
					<param name="movie" value="GoodGames/PixelGrower.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
