...
<div id="s-banner" style="background-image:url(../images/banners/courses.jpg)">
	<div id="s-banner-content"><span class="banner-text">CCW</span></div>
</div>
...
<div id="container">
        ...
        <div id="leftcolumn">
            ...
            <div class="content">
                <span class="large-text bold-text">Concealed Carry Weapons (CCW)</span><div class="line"></div>
            ...
            <div class="content">
                ...
                <span class="gen-text grey">
                    This Course will allow you to apply for a CCW in the county in which you reside.  This course does not guarantee your acceptance for a CCW permit.  A background check and additional charges will be assessed by the county of which you are applying.
                    
                    <br><br>

NOTE: I require that CCW participants have an intimate knowledge of their gun. They must know how the gun functions so they may fix any malfunctions that may occur.  Gun Handling skills similar to that taught in Pistol Art I and II must be displayed.   CCW holders have the responsibility to be competent, confident, and comfortable using their gun, they owe that to themselves, their loved ones, and the general public.  
                </span>
            </div> 
            ...
            <div class="content">
                ...
                <span class="gen-text grey">
      				...
      				<ul> 
                    	<li class="bullet">Cost:  $130</li>
                        <li class="bullet">Time: By Appointment</li>
                        <li class="bullet">Length: 8 hours</li>
                        ...
                        <li class="bullet">* 300+ rounds of ammunition (minimum)</li>
                    </ul>
            ...
            <div class="content">
            	<a onClick="prevPage(6)"><img id="prev_class"></a>
                <a onClick="nextPage(6)"><img id="next_class"></a>
            </div>
