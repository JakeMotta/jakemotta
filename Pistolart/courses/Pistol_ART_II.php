...
<div id="s-banner" style="background-image:url(../images/banners/courses.jpg)">
	<div id="s-banner-content"><span class="banner-text">Pistol ART II</span></div>
</div>
...
<div id="container">
        ...
        <div id="leftcolumn">
            ...
            <div class="content">
                <span class="large-text bold-text">Pistol ART II</span><div class="line"></div>
                <span class="gen-text grey">You will always be the first responder at your critical life incident. You must be prepared.</span>
            </div>
            
            <img id="class_photo" src="../images/courses/pistol_art_II.jpg">
            ...
            <div class="content">
                ...
                <span class="gen-text grey">
                    It’s beginning to get tactical!  Review of material covered in Pistol ART 1 and then we are in it.  Shooting from various positions, some movement (you have to get off the ”X”), multiple target engagements, CQB shooting , shooting from cover.  Twice as fun as the first course.      
                </span>
            </div> 
            ...
            <div class="content">
            	<span class="med-text bold-text">Course Benifits</span><div class="line"></div>  
                <span class="gen-text grey">
      				<ul> 
            ...
            <div class="content">
            	<a onClick="prevPage(2)"><img id="prev_class"></a>
                <a onClick="nextPage(2)"><img id="next_class"></a>
            </div>
