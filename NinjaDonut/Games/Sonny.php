...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="800" height="575" id="Games/sonny" align="middle">
				<param name="movie" value="GoodGames/sonny.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/sonny.swf" width="800" height="575">
					<param name="movie" value="GoodGames/sonny.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
