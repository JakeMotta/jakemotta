...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="720" height="480" id="Games/themindbender" align="middle">
				<param name="movie" value="GoodGames/themindbender.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/themindbender.swf" width="720" height="480">
					<param name="movie" value="GoodGames/themindbender.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
