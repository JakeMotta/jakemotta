...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="500" height="580" id="Games/shift-3" align="middle">
				<param name="movie" value="GoodGames/shift-3.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/shift-3.swf" width="500" height="580">
					<param name="movie" value="GoodGames/shift-3.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
