...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="500" height="400" id="Games/indestructocopter" align="middle">
				<param name="movie" value="GoodGames/indestructocopter.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/indestructocopter.swf" width="500" height="400">
					<param name="movie" value="GoodGames/indestructocopter.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
