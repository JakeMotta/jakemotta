<?php
    ...
    //define( 'K_DB_NAME', 'svbcc_database' );
	define( 'K_DB_NAME', 'jakemott_test' );
    // 5.
    // Database username
    //define( 'K_DB_USER', 'super_admin' ); //svbcc_admin for login
	define( 'K_DB_USER', 'jakemott_admin' ); //svbcc_admin for login
    // 6.
    // Database password 
    define( 'K_DB_PASSWORD', 'PaSV3AZ$6' );
    // 7.
    // MySQL hostname (it will usually be 'localhost' )
    define( 'K_DB_HOST', 'host174.hostmonster.com' );
    //define( 'K_DB_HOST', 'svbcc02.powwebmysql.com' );
    // 7b.
