...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="500" height="400" id="Games/theriseoftheking" align="middle">
				<param name="movie" value="GoodGames/theriseoftheking.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/theriseoftheking.swf" width="500" height="400">
					<param name="movie" value="GoodGames/theriseoftheking.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
