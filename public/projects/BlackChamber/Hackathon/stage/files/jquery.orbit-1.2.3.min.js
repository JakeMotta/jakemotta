  ...
  d.fn.orbit = function (a) {
    ...
    return this.each(function () {
        ...
        if (!a.captions || a.captions == 'false') return !1;
          ...
          (_captionHTML = d(c).html())
            ? (j.attr('id', c).html(_captionHTML),
              ...
              a.captionAnimation == 'slideOpen' && j.slideDown(a.captionAnimationSpeed))
            : (a.captionAnimation == 'none' && j.hide(), a.captionAnimation == 'fade' && j.fadeOut(a.captionAnimationSpeed), a.captionAnimation == 'slideOpen' && j.slideUp(a.captionAnimationSpeed));
        }
      }
      function A() {
      ...
      function l(c) {
        ...
        u ||
          ((u = !0),
          c == 'next' ? (b++, b == p && (b = 0)) : c == 'prev' ? (b--, b < 0 && (b = p - 1)) : ((b = c), f < b ? (g = 'next') : f > b && (g = 'prev')),
          A(),
          e.eq(f).css({ 'z-index': 2 }),
          a.animation == 'fade' && e.eq(b).css({ opacity: 0, 'z-index': 3 }).animate({ opacity: 1 }, a.animationSpeed, d),
          a.animation == 'horizontal-slide' &&
            (g == 'next' && e.eq(b).css({ left: h, 'z-index': 3 }).animate({ left: 0 }, a.animationSpeed, d),
            g == 'prev' && e.eq(b).css({ left: -h, 'z-index': 3 }).animate({ left: 0 }, a.animationSpeed, d)),
          a.animation == 'vertical-slide' &&
            (g == 'prev' && e.eq(b).css({ top: v, 'z-index': 3 }).animate({ top: 0 }, a.animationSpeed, d),
            g == 'next' && e.eq(b).css({ top: -v, 'z-index': 3 }).animate({ top: 0 }, a.animationSpeed, d)),
          a.animation == 'horizontal-push' &&
            (g == 'next' && (e.eq(b).css({ left: h, 'z-index': 3 }).animate({ left: 0 }, a.animationSpeed, d), e.eq(f).animate({ left: -h }, a.animationSpeed)),
            g == 'prev' && (e.eq(b).css({ left: -h, 'z-index': 3 }).animate({ left: 0 }, a.animationSpeed, d), e.eq(f).animate({ left: h }, a.animationSpeed))),
          z());
      }
      var b = 0,
        p = 0,
