...
(window.Modernizr = (function (e, t, n) {
  ...
  function N(e, t, r) {
    for (var i in e) {
      var s = t[e[i]];
      if (s !== n) return r === !1 ? e[i] : x(s, 'function') ? s.bind(r || t) : s;
    }
    return !1;
  }
  var r = '2.8.3',
    ...
    b = {}.hasOwnProperty,
    w;
  !x(b, 'undefined') && !x(b.call, 'undefined')
    ? (w = function (e, t) {
        return b.call(e, t);
      })
    : (w = function (e, t) {
        return t in e && x(e.constructor.prototype[t], 'undefined');
      }),
  ...
  for (var C in p) w(p, C) && ((y = C.toLowerCase()), (i[y] = p[C]()), m.push((i[y] ? '' : 'no-') + y));
  return (
    (i.addTest = function (e, t) {
      if (typeof e == 'object') for (var r in e) w(e, r) && i.addTest(r, e[r]);
      else {
        e = e.toLowerCase();
        if (i[e] !== n) return i;
    ...
    (function (e, t) {
      ...
      function d(e, n, r) {
        ...
        var o;
        return (
          r.cache[e] ? (o = r.cache[e].cloneNode()) : s.test(e) ? (o = (r.cache[e] = r.createElem(e)).cloneNode()) : (o = r.createElem(e)),
    ...
    (i._version = r),
    (o.className = o.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (s ? ' js ' + m.join(' ') : '')),
    i
  );
})(this, this.document)),
  (function (e, t, n) {
