...
<div id="s-banner" style="background-image:url(../images/banners/courses.jpg)">
	<div id="s-banner-content"><span class="banner-text">Low Light Pistols</span></div>
</div>
...
<div id="container">
        ...
        <div id="leftcolumn">
            ...
            <div class="content">
                <span class="large-text bold-text">Low Light Pistols</span><div class="line"></div>
            ...
            <div class="content">
                ...
                Many critical life incidents, where you may have to deploy your gun, occur in low-light or no light environments.  This can be during the hours of darkness, in a dark room, or in an environment with limited ambient light. <br><br>
                If you carry a weapon as part of your job or as a responsible citizen, then an illumination tool is an essential component of your EDC.<br><br>
                This course will cover both handheld and weapons mounted light techniques.  Students will learn to Navigate, Search, and Control using their particular lighting preference.  Students will discover which particular light techniques and grip will work best for them. <br><br>
                Come and see what you cant see.
                </span>
            </div> 
            ...
            <div class="content">
                ...
                <span class="gen-text grey">
                  ...
                  <ul> 
                    ...
                    <li class="bullet">Length: 6 hours</li>
                    <li class="bullet">Handheld light w/ lanyard</li>
                    <li class="bullet">Weapons mounted light (optional)</li>
                    ...
                    <li class="bullet">* eye / ear equipment</li>
                  </ul>
            ...
            <div class="content">
            	<a onClick="prevPage(7)"><img id="prev_class"></a>
                <a onClick="nextPage(7)"><img id="next_class"></a>
            </div>
