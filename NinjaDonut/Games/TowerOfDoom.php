...
<hr />
<div align="center">
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="650" height="670" id="Games/tower-of-doom" align="middle">
				<param name="movie" value="GoodGames/tower-of-doom.swf" />
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="GoodGames/tower-of-doom.swf" width="650" height="670">
					<param name="movie" value="GoodGames/tower-of-doom.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
